...
public class BrobIntTester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("      expecting: positive value and got: "
                    + (new BrobInt("123456789").compareTo(new BrobInt("234"))));
        } catch (Exception e) {
            System.out.println("        Exception thrown:  ");
        }
        ...
        try {
            ...
            System.out.println("      expecting: ngative value and got: "
                    + (new BrobInt("123").compareTo(new BrobInt("123456789"))));
        } catch (Exception e) {
            System.out.println("        Exception thrown:  ");
        }
