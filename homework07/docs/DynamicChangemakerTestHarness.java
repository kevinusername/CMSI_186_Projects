...
public class DynamicChangemakerTestHarness {
    ...
    public static void test_USA() {
        ...
        System.out.println("\n    Test" + makeTwoDigits() + ": testing optimal solution for 6 cents using "
                + Arrays.toString(newDenominations) + ": ");
        ...
        System.out.println("\n    Test" + makeTwoDigits() + ": testing optimal solution for 13579 cents using "
                + Arrays.toString(newDenominations) + ": ");
        ...
        System.out.println("\n    Test" + makeTwoDigits() + ": testing optimal solution for 12 cents using "
                + Arrays.toString(newDenominations) + ": ");
        ...
        System.out.println("\n    Test" + makeTwoDigits() + ": testing for impossible solution for 14 cents using "
                + Arrays.toString(newDenominations) + ": ");
        ...
        System.out.println("\n    Test" + makeTwoDigits() + ": testing for optimalsolution for 1357911 cents using "
                + Arrays.toString(newDenominations) + ": ");
    ...
    public static void test_BogusDenominations1() {
        ...
        System.out.println("\n    Test " + makeTwoDigits()
                + ": testing first list of bogus denominations, containing a negative......");
    ...
    public static void test_BogusDenominations2() {
        ...
        System.out.println("\n    Test " + makeTwoDigits()
                + ": testing second list of bogus denominations, containing a zero......");
        System.out.println("          expecting: BAD DATA and a message: ");
        System.out.print("            and got: ");
        try {
            Tuple result = DynamicChangeMaker.makeChangeWithDynamicProgramming(badDenominations, 2345);
    ...
    public static void test_BogusDenominations3() {
        ...
        System.out.println("\n    Test " + makeTwoDigits()
                + ": testing third list of bogus denominations, containing repeats......");
        System.out.println("          expecting: BAD DATA and a message: ");
        System.out.print("            and got: ");
        try {
            Tuple result = DynamicChangeMaker.makeChangeWithDynamicProgramming(badDenominations, 2345);
