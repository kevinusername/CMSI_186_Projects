...
public class TupleTestHarness {
    ...
    */
    public static void test_toString() {
        ...
        try {
            System.out.println("Test " + makeTwoDigits()
                    + "    : testing if '<>' [empty Tuple] equals fakeImpossible.toString():");
            System.out.print("  Expecting: 'true': ");
        ...
        try {
            ...
            System.out.println(
                    "Test " + makeTwoDigits() + "    : testing constructing '<13,11,23,19,5,29>' [six-Tuple]:");
            System.out.print("  Expecting: 'true': ");
        ...
        try {
            ...
            System.out.println("Test " + makeTwoDigits()
                    + "    : testing constructing '<17,53,29,31,5,7,11,47,19,71>' [ten-Tuple]:");
            System.out.print("  Expecting: 'true': ");
    ...
    */
    public static void test_setElement() {
        ...
        try {
            System.out.println(
                    "Test " + makeTwoDigits() + "    : testing setting element zero of '<3,1,2>' [three-Tuple] to -1:");
        ...
        try {
            System.out.println(
                    "Test " + makeTwoDigits() + "    : testing setting element one of '<-1,1,2>' [three-Tuple] to 0:");
            System.out.println("  currently: " + t0.toString());
            t0.setElement(1, 0);
        ...
        try {
            System.out.println(
                    "Test " + makeTwoDigits() + "    : testing setting element two of '<-1,0,2>' [three-Tuple] to 15:");
            System.out.println("  currently: " + t0.toString());
            t0.setElement(2, 15);
    ...
    */
    public static void test_add() {
        try {
            ...
            displaySuccessIfTrue("<2,1,4>".equals(sum.toString()) && "<-1,0,2>".equals(t0.toString())
    ...
    */
    public static void test_length() {
        ...
        try {
            System.out.println(
                    "Test " + makeTwoDigits() + "    : testing length on '<17,53,29,31,5,7,11,47,19,71>' [ten-Tuple]:");
            System.out.print("  Expecting: 'true': ");
            Tuple t5 = new Tuple(new int[] { 17, 53, 29, 31, 5, 7, 11, 47, 19, 71 });
